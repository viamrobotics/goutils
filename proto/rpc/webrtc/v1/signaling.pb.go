...
type AnswerRequestInitStage struct {
	...
	// caller_access_token is the signed bearer token the caller authenticated to the
	// signaling server with, forwarded from the (trusted) signaler so the answerer can
	// identify the caller for authorization. Empty when the caller was unauthenticated.
	CallerAccessToken *string `protobuf:"bytes,4,opt,name=caller_access_token,json=callerAccessToken,proto3,oneof" json:"caller_access_token,omitempty"`
}
...
func (x *AnswerRequestInitStage) GetCallerAccessToken() string {
	if x != nil && x.CallerAccessToken != nil {
		return *x.CallerAccessToken
	}
	return ""
}
...
var file_proto_rpc_webrtc_v1_signaling_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x54, 0x72, 0x69, 0x63, 0x6b, 0x6c, 0x65, 0x22, 0x8d, 0x02, 0x0a, 0x16, 0x41, 0x6e,
	...
	0x33, 0x0a, 0x13, 0x63, 0x61, 0x6c, 0x6c, 0x65, 0x72, 0x5f, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73,
	0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x48, 0x01, 0x52, 0x11,
	0x63, 0x61, 0x6c, 0x6c, 0x65, 0x72, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65,
	0x6e, 0x88, 0x01, 0x01, 0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x64, 0x65, 0x61, 0x64, 0x6c, 0x69, 0x6e,
	0x65, 0x42, 0x16, 0x0a, 0x14, 0x5f, 0x63, 0x61, 0x6c, 0x6c, 0x65, 0x72, 0x5f, 0x61, 0x63, 0x63,
	0x65, 0x73, 0x73, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x5b, 0x0a, 0x18, 0x41, 0x6e, 0x73,
...
var file_proto_rpc_webrtc_v1_signaling_proto_depIdxs = []int32{
	...
	28, // 4: proto.rpc.webrtc.v1.CallUpdateRequest.error:type_name -> google.rpc.Status
	...
	29, // 7: proto.rpc.webrtc.v1.AnswerRequestInitStage.deadline:type_name -> google.protobuf.Timestamp
	3,  // 8: proto.rpc.webrtc.v1.AnswerRequestUpdateStage.candidate:type_name -> proto.rpc.webrtc.v1.ICECandidate
	28, // 9: proto.rpc.webrtc.v1.AnswerRequestErrorStage.status:type_name -> google.rpc.Status
	12, // 10: proto.rpc.webrtc.v1.AnswerRequest.init:type_name -> proto.rpc.webrtc.v1.AnswerRequestInitStage
	13, // 11: proto.rpc.webrtc.v1.AnswerRequest.update:type_name -> proto.rpc.webrtc.v1.AnswerRequestUpdateStage
	14, // 12: proto.rpc.webrtc.v1.AnswerRequest.done:type_name -> proto.rpc.webrtc.v1.AnswerRequestDoneStage
	15, // 13: proto.rpc.webrtc.v1.AnswerRequest.error:type_name -> proto.rpc.webrtc.v1.AnswerRequestErrorStage
	16, // 14: proto.rpc.webrtc.v1.AnswerRequest.heartbeat:type_name -> proto.rpc.webrtc.v1.AnswerRequestHeartbeatStage
	3,  // 15: proto.rpc.webrtc.v1.AnswerResponseUpdateStage.candidate:type_name -> proto.rpc.webrtc.v1.ICECandidate
	28, // 16: proto.rpc.webrtc.v1.AnswerResponseErrorStage.status:type_name -> google.rpc.Status
	18, // 17: proto.rpc.webrtc.v1.AnswerResponse.init:type_name -> proto.rpc.webrtc.v1.AnswerResponseInitStage
	19, // 18: proto.rpc.webrtc.v1.AnswerResponse.update:type_name -> proto.rpc.webrtc.v1.AnswerResponseUpdateStage
	20, // 19: proto.rpc.webrtc.v1.AnswerResponse.done:type_name -> proto.rpc.webrtc.v1.AnswerResponseDoneStage
	21, // 20: proto.rpc.webrtc.v1.AnswerResponse.error:type_name -> proto.rpc.webrtc.v1.AnswerResponseErrorStage
	11, // 21: proto.rpc.webrtc.v1.OptionalWebRTCConfigResponse.config:type_name -> proto.rpc.webrtc.v1.WebRTCConfig
	0,  // 22: proto.rpc.webrtc.v1.ConnectionCandidate.type:type_name -> proto.rpc.webrtc.v1.ICECandidateType
	25, // 23: proto.rpc.webrtc.v1.ReportConnectionMetadataRequest.local:type_name -> proto.rpc.webrtc.v1.ConnectionCandidate
	25, // 24: proto.rpc.webrtc.v1.ReportConnectionMetadataRequest.remote:type_name -> proto.rpc.webrtc.v1.ConnectionCandidate
	1,  // 25: proto.rpc.webrtc.v1.ReportConnectionMetadataRequest.reached_stage:type_name -> proto.rpc.webrtc.v1.DialStage
	2,  // 26: proto.rpc.webrtc.v1.ReportConnectionMetadataRequest.signaling_path:type_name -> proto.rpc.webrtc.v1.ConnectionSignalingPath
	4,  // 27: proto.rpc.webrtc.v1.SignalingService.Call:input_type -> proto.rpc.webrtc.v1.CallRequest
	8,  // 28: proto.rpc.webrtc.v1.SignalingService.CallUpdate:input_type -> proto.rpc.webrtc.v1.CallUpdateRequest
	22, // 29: proto.rpc.webrtc.v1.SignalingService.Answer:input_type -> proto.rpc.webrtc.v1.AnswerResponse
	23, // 30: proto.rpc.webrtc.v1.SignalingService.OptionalWebRTCConfig:input_type -> proto.rpc.webrtc.v1.OptionalWebRTCConfigRequest
	26, // 31: proto.rpc.webrtc.v1.SignalingService.ReportConnectionMetadata:input_type -> proto.rpc.webrtc.v1.ReportConnectionMetadataRequest
	7,  // 32: proto.rpc.webrtc.v1.SignalingService.Call:output_type -> proto.rpc.webrtc.v1.CallResponse
	9,  // 33: proto.rpc.webrtc.v1.SignalingService.CallUpdate:output_type -> proto.rpc.webrtc.v1.CallUpdateResponse
	17, // 34: proto.rpc.webrtc.v1.SignalingService.Answer:output_type -> proto.rpc.webrtc.v1.AnswerRequest
	24, // 35: proto.rpc.webrtc.v1.SignalingService.OptionalWebRTCConfig:output_type -> proto.rpc.webrtc.v1.OptionalWebRTCConfigResponse
	27, // 36: proto.rpc.webrtc.v1.SignalingService.ReportConnectionMetadata:output_type -> proto.rpc.webrtc.v1.ReportConnectionMetadataResponse
