...
type AnswerRequestInitStage struct {
	...
	// caller_metadata is the caller's authenticated identity, extracted from its auth token
	// by the (trusted) signaling server: the entity (JWT subject) and its auth metadata
	// (rpc_auth_md) claim. Only this identity is forwarded to the answerer — never the
	// caller's bearer token, which a malicious answerer could replay to impersonate the
	// caller elsewhere. Unset when the caller was unauthenticated.
	CallerMetadata *AuthenticatedCaller `protobuf:"bytes,4,opt,name=caller_metadata,json=callerMetadata,proto3,oneof" json:"caller_metadata,omitempty"`
}
...
func (x *AnswerRequestInitStage) GetCallerMetadata() *AuthenticatedCaller {
	if x != nil {
...
// AuthenticatedCaller is a WebRTC caller's authenticated identity, extracted by the
// signaling server and forwarded to the answerer so it can identify the caller for
// authorization without receiving the caller's (replayable) bearer token.
...
func (x *AuthenticatedCaller) GetEntity() string {
	if x != nil {
		return x.Entity
	}
	return ""
...
func (x *AuthenticatedCaller) GetMetadata() map[string]string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *ReportConnectionMetadataResponse) Reset() {
	*x = ReportConnectionMetadataResponse{}
	mi := &file_proto_rpc_webrtc_v1_signaling_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReportConnectionMetadataResponse) Descriptor() ([]byte, []int) {
	return file_proto_rpc_webrtc_v1_signaling_proto_rawDescGZIP(), []int{25}
}
...
var file_proto_rpc_webrtc_v1_signaling_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x54, 0x72, 0x69, 0x63, 0x6b, 0x6c, 0x65, 0x22, 0xac, 0x02, 0x0a, 0x16, 0x41, 0x6e,
	...
	,
	...
	,
	...
	,
...
var file_proto_rpc_webrtc_v1_signaling_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_proto_rpc_webrtc_v1_signaling_proto_goTypes = []any{
	...
	(*AuthenticatedCaller)(nil),              // 13: proto.rpc.webrtc.v1.AuthenticatedCaller
	...
	nil,                                      // 29: proto.rpc.webrtc.v1.AuthenticatedCaller.MetadataEntry
...
var file_proto_rpc_webrtc_v1_signaling_proto_depIdxs = []int32{
	...
	30, // 4: proto.rpc.webrtc.v1.CallUpdateRequest.error:type_name -> google.rpc.Status
	...
	31, // 7: proto.rpc.webrtc.v1.AnswerRequestInitStage.deadline:type_name -> google.protobuf.Timestamp
	13, // 8: proto.rpc.webrtc.v1.AnswerRequestInitStage.caller_metadata:type_name -> proto.rpc.webrtc.v1.AuthenticatedCaller
	29, // 9: proto.rpc.webrtc.v1.AuthenticatedCaller.metadata:type_name -> proto.rpc.webrtc.v1.AuthenticatedCaller.MetadataEntry
	3,  // 10: proto.rpc.webrtc.v1.AnswerRequestUpdateStage.candidate:type_name -> proto.rpc.webrtc.v1.ICECandidate
	30, // 11: proto.rpc.webrtc.v1.AnswerRequestErrorStage.status:type_name -> google.rpc.Status
	12, // 12: proto.rpc.webrtc.v1.AnswerRequest.init:type_name -> proto.rpc.webrtc.v1.AnswerRequestInitStage
	14, // 13: proto.rpc.webrtc.v1.AnswerRequest.update:type_name -> proto.rpc.webrtc.v1.AnswerRequestUpdateStage
	15, // 14: proto.rpc.webrtc.v1.AnswerRequest.done:type_name -> proto.rpc.webrtc.v1.AnswerRequestDoneStage
	16, // 15: proto.rpc.webrtc.v1.AnswerRequest.error:type_name -> proto.rpc.webrtc.v1.AnswerRequestErrorStage
	17, // 16: proto.rpc.webrtc.v1.AnswerRequest.heartbeat:type_name -> proto.rpc.webrtc.v1.AnswerRequestHeartbeatStage
	3,  // 17: proto.rpc.webrtc.v1.AnswerResponseUpdateStage.candidate:type_name -> proto.rpc.webrtc.v1.ICECandidate
	30, // 18: proto.rpc.webrtc.v1.AnswerResponseErrorStage.status:type_name -> google.rpc.Status
	19, // 19: proto.rpc.webrtc.v1.AnswerResponse.init:type_name -> proto.rpc.webrtc.v1.AnswerResponseInitStage
	20, // 20: proto.rpc.webrtc.v1.AnswerResponse.update:type_name -> proto.rpc.webrtc.v1.AnswerResponseUpdateStage
	21, // 21: proto.rpc.webrtc.v1.AnswerResponse.done:type_name -> proto.rpc.webrtc.v1.AnswerResponseDoneStage
	22, // 22: proto.rpc.webrtc.v1.AnswerResponse.error:type_name -> proto.rpc.webrtc.v1.AnswerResponseErrorStage
	11, // 23: proto.rpc.webrtc.v1.OptionalWebRTCConfigResponse.config:type_name -> proto.rpc.webrtc.v1.WebRTCConfig
	0,  // 24: proto.rpc.webrtc.v1.ConnectionCandidate.type:type_name -> proto.rpc.webrtc.v1.ICECandidateType
	26, // 25: proto.rpc.webrtc.v1.ReportConnectionMetadataRequest.local:type_name -> proto.rpc.webrtc.v1.ConnectionCandidate
	26, // 26: proto.rpc.webrtc.v1.ReportConnectionMetadataRequest.remote:type_name -> proto.rpc.webrtc.v1.ConnectionCandidate
	1,  // 27: proto.rpc.webrtc.v1.ReportConnectionMetadataRequest.reached_stage:type_name -> proto.rpc.webrtc.v1.DialStage
	2,  // 28: proto.rpc.webrtc.v1.ReportConnectionMetadataRequest.signaling_path:type_name -> proto.rpc.webrtc.v1.ConnectionSignalingPath
	4,  // 29: proto.rpc.webrtc.v1.SignalingService.Call:input_type -> proto.rpc.webrtc.v1.CallRequest
	8,  // 30: proto.rpc.webrtc.v1.SignalingService.CallUpdate:input_type -> proto.rpc.webrtc.v1.CallUpdateRequest
	23, // 31: proto.rpc.webrtc.v1.SignalingService.Answer:input_type -> proto.rpc.webrtc.v1.AnswerResponse
	24, // 32: proto.rpc.webrtc.v1.SignalingService.OptionalWebRTCConfig:input_type -> proto.rpc.webrtc.v1.OptionalWebRTCConfigRequest
	27, // 33: proto.rpc.webrtc.v1.SignalingService.ReportConnectionMetadata:input_type -> proto.rpc.webrtc.v1.ReportConnectionMetadataRequest
	7,  // 34: proto.rpc.webrtc.v1.SignalingService.Call:output_type -> proto.rpc.webrtc.v1.CallResponse
	9,  // 35: proto.rpc.webrtc.v1.SignalingService.CallUpdate:output_type -> proto.rpc.webrtc.v1.CallUpdateResponse
	18, // 36: proto.rpc.webrtc.v1.SignalingService.Answer:output_type -> proto.rpc.webrtc.v1.AnswerRequest
	25, // 37: proto.rpc.webrtc.v1.SignalingService.OptionalWebRTCConfig:output_type -> proto.rpc.webrtc.v1.OptionalWebRTCConfigResponse
	28, // 38: proto.rpc.webrtc.v1.SignalingService.ReportConnectionMetadata:output_type -> proto.rpc.webrtc.v1.ReportConnectionMetadataResponse
...
func file_proto_rpc_webrtc_v1_signaling_proto_init() {
	...
	file_proto_rpc_webrtc_v1_signaling_proto_msgTypes[15].OneofWrappers = []any{
	...
	file_proto_rpc_webrtc_v1_signaling_proto_msgTypes[20].OneofWrappers = []any{
