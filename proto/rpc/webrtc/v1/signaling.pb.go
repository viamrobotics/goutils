...
// ConnectionTransport is how a WebRTC dial was signaled derived from the signaling address.
type ConnectionTransport int32

const (
	ConnectionTransport_CONNECTION_TRANSPORT_UNSPECIFIED ConnectionTransport = 0
	// CONNECTION_TRANSPORT_CLOUD_SIGNALED: signaled through app's signaling server.
...
type ReportConnectionMetadataRequest struct {
	...
	// transport is how the dial was signaled (cloud / local / mDNS); reported regardless of outcome.
	...
	// failure_code is the gRPC status code of a failed dial (see google.rpc.Code); 0 (OK) when the dial succeeded.
