...
func (x *Request) GetApiToken() string {
	if x, ok := x.GetType().(*Request_ApiToken); ok {
		return x.ApiToken
	}
	return ""
}
...
type Request_ApiToken struct {
	// api_token lets a client authenticate with the answerer over the PeerConnection when
	// the signaling server could not authenticate it. In the form `<api-key-id>:<api-key>`.
	ApiToken string `protobuf:"bytes,5,opt,name=api_token,json=apiToken,proto3,oneof"`
}
...
func (*Request_ApiToken) isRequest_Type() {}
...
var file_proto_rpc_webrtc_v1_grpc_proto_rawDesc = []byte{
	...
	0x88, 0x02, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x33, 0x0a, 0x06, 0x73,
	...
	0x65, 0x61, 0x6d, 0x12, 0x1d, 0x0a, 0x09, 0x61, 0x70, 0x69, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x08, 0x61, 0x70, 0x69, 0x54, 0x6f, 0x6b,
	0x65, 0x6e, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x98, 0x01, 0x0a, 0x0e, 0x52,
