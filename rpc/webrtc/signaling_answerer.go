...
// Note: right now the implementation of SignalingAnswerer and SignalingServer are bound
...
func (ans *SignalingAnswerer) answer() (err error) {
	...
	exchangeCtx, exchangeCancel := context.WithTimeout(ans.closeCtx, connectionTimeout)
